    ...
    <header class="intro-header">
      <div class="container">
        <div class="intro-message">
          <ul id="playlist">
        <li class="active">
            <a>Setapak Sriwedari - Maliq</a>
            <audio controls="controls">
           <source src="songlist/02 Setapak Sriwedari.mp3"/ id="audio">
          Your browser does not support the audio element.
            </audio>
        </li>
        <li>
            <a>Soul On Fire - Gugun and the blueshelter</a>
            <audio controls="controls">
           <source src="songlist/03 Soul On Fire.mp3"/ id="audio">
          Your browser does not support the audio element.
            </audio>
        </li>
        <li>
        <a>Coba Katakan - Maliq</a>
            <audio controls="controls">
           <source src="songlist/05 Coba Katakan.mp3"/ id="audio">
          Your browser does not support the audio element.
            </audio>
        </li>
        <li>
        <a>Heaven - Maliq</a>
            <audio controls="controls">
           <source src="songlist/05 Heaven.mp3"/ id="audio">
          Your browser does not support the audio element.
            </audio>
        </li>
        <li>
        <a>Drive - Incubus</a>
            <audio controls="controls">
           <source src="songlist/08 Drive.mp3"/ id="audio">
          Your browser does not support the audio element.
            </audio>
        </li>
    </ul>
    ...
    <!-- <header class="intro-header">
      <div class="container">
        <div class="intro-message">
          ...
          <audio controls="controls">
           <source src="http://192.168.100.18:8000/listen.m3u"/ id="audio">
          Your browser does not support the audio element.
            </audio>
        </div>
      </div> -->
